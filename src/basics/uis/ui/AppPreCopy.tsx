...
export default function AppPreCopy(props: AppTextAreaProps) {
    return (
        <div>
            <label class="label">
                ...
                <span class="label-text-alt">
                    <Show when={props.showCopy}>
                        <button class="btn" onClick={() => navigator.clipboard.writeText(props.value || '')}>
            ...
            <pre class="textarea textarea-bordered break-all whitespace-wrap">{props.value}</pre>
        </div>
    );
}
